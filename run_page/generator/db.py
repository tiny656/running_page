    ...
    try:
        ...
        if not activity:
            ...
            activity = Activity(
                ...
                elevation_gain= float(run_activity.elevation_gain) if run_activity.elevation_gain is not None else None
            ...
            activity.elevation_gain= float(run_activity.elevation_gain) if run_activity.elevation_gain is not None else None
