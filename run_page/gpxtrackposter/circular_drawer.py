...
class CircularDrawer(TracksDrawer):
    ...
    def _draw_year(self, dr: svgwrite.Drawing, size: XY, offset: XY, year: int):
        ...
        year_style = f'dominant-baseline: central; font-size:{min_size * 4.0 / 80.0}px; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Helvetica Neue", Helvetica, "Segoe UI", Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC", "Microsoft YaHei", "WenQuanYi Micro Hei", sans-serif;'
        month_style = f'font-size:{min_size * 3.0 / 80.0}px; font-family: system-ui, -apple-system, BlinkMacSystemFont, "Helvetica Neue", Helvetica, "Segoe UI", Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC", "Microsoft YaHei", "WenQuanYi Micro Hei", sans-serif;'
